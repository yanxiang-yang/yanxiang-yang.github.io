...
## Research Interests
My main research line focuses on <b>sport, gamification, and health management</b>. In particular, the goal of my research is to understand the role of gamification in digital sport and health behaviors and gamified health information systems. I am also interested in topics of <b>sports behavioral analytics</b>. I use multiple research methodologies including quantitative (e.g. machine learning-based causal inference, agent-based models, structural equation modeling, web scraping, meta-analysis) and qualitative (e.g. semi-structured interview) approach. Our work has appeared in renowned journals such as Computers in Human Behavior, European Sport Management Quarterly, Journal of Sport Management, Nonprofit Management and Leadership, American Journal of Preventive Medicine, Journal of Medical Internet Research, among others. My research keywords are:

* Gamification
* Digital sport and health management
* Sports behavioral analytics


## Selected Journal Publications

1. <b>Yanxiang Yang</b>, Terri Byers, and Joerg Koenigstorfer (2025): A machine learning approach to understanding performance of Canadian nonprofit sport organizations. <i>Nonprofit Management & Leadership</i>. [DOI](https://doi.org/10.1002/nml.21651) [News](https://www.hs.mh.tum.de/en/mgt/news-single-view-en/article/nutzung-von-machine-learning-zur-erklaerung-von-leistungsindikatoren-von-sportvereinen/)
2. Tamara Seufert, <b>Yanxiang Yang</b>, Iris Perey, and Joerg Koenigstorfer (2025): Fan attitude toward athlete activism for Black Lives Matter. <i>Journal of Sport & Social Issues</i>. [DOI](https://doi.org/10.1177/01937235251334584)
3. <b>Yanxiang Yang</b> and Joerg Koenigstorfer (2025): The curvilinear effects of relative positions in smartphone App leaderboards on physical activity. <i>Computers in Human Behavior</i>. [DOI](https://doi.org/10.1016/j.chb.2024.108532) [News](https://tiyuxi.sjtu.edu.cn/info/1079/28161.htm) [News](https://www.hs.mh.tum.de/en/mgt/news-single-view-en/article/wann-motivieren-ranglisten-zur-koerperlichen-aktivitaet-einblicke-aus-empirischen-studien/)
